...
void ThreadsafeStack<T>::push(const T &value){
    ...
    std::shared_ptr<Node<T>> first = this->front;
    this->front = newNode;
...
splitted = re.split(r'ThreadsafeStack\s*{', student_answer)
student_answer = splitted[0] + 'ThreadsafeStack {' + functions_to_add + splitted[1]
